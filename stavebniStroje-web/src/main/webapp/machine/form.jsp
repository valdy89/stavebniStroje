...
<div class="row form-group">
    <div class="control-label col-sm-3">
        <s:label for="name" name="machine.name">
            <f:message key="machine.name"/>
        </s:label>
    </div>
    <div class="col-sm-9">
...
<div class="row form-group">
    <div class="control-label col-sm-3">
        <s:label for="category" name="machine.type">
            <f:message key="machine.type"/>
        </s:label>
    </div>
    <div class="col-sm-9">
...
<div class="row form-group">
    <div class="control-label col-sm-3">
        <s:label for="price" name="machine.price">
            <f:message key="machine.price"/>
        </s:label>
    </div>
    <div class="col-sm-9">
...
<div class="row form-group">
    <div class="control-label col-sm-3">
        <s:label for="description" name="machine.description">
            <f:message key="machine.description"/>
        </s:label>
    </div>
    <div class="col-sm-9">
