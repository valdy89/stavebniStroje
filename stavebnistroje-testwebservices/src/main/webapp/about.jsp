...
<html>
    ...
    <body>
        ...
        <p>Application was created as part of the project for class PA165: Enterprise Applications in Java at Faculty of Informatics, Masaryk University. 
        </p>
        <br>
        <h4>Authors:</h4>
        <p>
